...
//https://arduino-info.wikispaces.com/Arduino-PWM-Frequency
 ...
 attachInterrupt(1, blink, RISING); //pin21
 elapsedTime=0;
...
void loop() {
    ...
    if(Serial.available()>0)
  {
      ...
      if(referencia=='1') referencia=5;
      else if(referencia=='2') referencia=10;
      else if(referencia=='3') referencia=20;
      else if(referencia=='4') referencia=30;
